...
# Filters v2
@bp.route('/api/v2/sections/<string:campus>/<string:yearsession>/<string:subject>/<string:course>', methods=['GET'])
...
@bp.route('/api/v2/courses/<string:campus>/<string:yearsession>/<string:subject>', methods=['GET'])
...
@bp.route('/api/v2/courses/<string:campus>/<string:subject>', methods=['GET'])
...
@bp.route('/api/v2/subjects/<string:campus>/<string:yearsession>', methods=['GET'])
...
@bp.route('/api/v2/yearsessions/<string:campus>', methods=['GET'])
...
# Filters v2
@bp.route('/api/v1/sections/<string:campus>/<string:yearsession>/<string:subject>/<string:course>', methods=['GET'])
...
@bp.route('/api/v1/courses/<string:campus>/<string:yearsession>/<string:subject>', methods=['GET'])
...
@bp.route('/api/v1/courses/<string:campus>/<string:subject>', methods=['GET'])
...
@bp.route('/api/v1/subjects/<string:campus>/<string:yearsession>', methods=['GET'])
...
@bp.route('/api/v1/yearsessions/<string:campus>', methods=['GET'])
